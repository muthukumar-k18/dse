...
export default function AAFUserPage() {
        ...
        <section className="flex justify-between items-center mb-8">
          <div>
            ...
            <h1 className="text-3xl font-bold tracking-tight">
              Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-red-400 to-orange-400">AAF Migration Consultant</span> Workspace
            </h1>
            <p className="text-white/60 text-sm mt-2">
              Advanced Feature Framework • {activeProjects.length} active projects • 8 pipelines running
            </p>
          </div>
